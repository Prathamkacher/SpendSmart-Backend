...
class GlobalExceptionHandlerTest {
    ...
    void handleValidationErrors_ShouldReturnFieldMap() throws Exception {
        BeanPropertyBindingResult bindingResult = new BeanPropertyBindingResult(new Object(), "expense");
        bindingResult.addError(new FieldError("expense", "title", "Title is required"));
    ...
    void handlers_ShouldReturnExpectedStatusCodes() {
        assertThat(handler.handleExpenseNotFound(new ExpenseNotFoundException(5L)).getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
    ...
    @Test
    void genericHandler_ShouldReturn500WithExceptionType() {
